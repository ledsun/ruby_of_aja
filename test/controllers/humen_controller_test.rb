...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference('Human.count') do
      post humen_url, params: { human: { aim: @human.aim, category: @human.category, expected_time: @human.expected_time, order: @human.order, problem: @human.problem, solution: @human.solution } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { aim: @human.aim, category: @human.category, expected_time: @human.expected_time, order: @human.order, problem: @human.problem, solution: @human.solution } }
